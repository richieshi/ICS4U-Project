...
<!--
adv.php
Created by Howard Chen on May 24, 2013
...
<div id="container">
		<div id="header">
		<h1><span class="off">&nbsp;&nbsp;Advanced Search</span></h1>
		</div>
		<div id="leftmenu">
	...
	<table border=1 cellpadding=3>
		...
		<tr>
			<td rowspan=6><select name="select">
				<option value="*" selected>All</option>
				<option value="title">Title</option>
				<option value="author">Author</option>
			</select></td>
			<td>Contains any of these words</td>
			<td><input type="text" name="any"></td>
		</tr>
		<tr>
			<td>Contains all of these words</td>
			<td><input type="text" name="all"></td>
		</tr>
		<tr>
			<td>Contains none of these words</td>
